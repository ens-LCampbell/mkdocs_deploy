...
project = 'Ensembl Python Template'
...
man_pages = [
    (master_doc, 'ensembl-python-template', 'Ensembl - Python Template Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Ensembl-Python-Template', 'Ensembl - Python Template Documentation',
     author, 'Ensembl-Python-Template', 'One line description of project.',
     'Miscellaneous'),
]
